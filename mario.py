...
if __name__ == "__main__":
    ...
    train_env = make_mario_env(
        ...
        use_vec_normalize=True,
        vec_normalize_kwargs={"training": True, "norm_reward": True, "gamma": 0.95},
    ...
    eval_env = make_mario_env(
        ...
        wrapper_kwargs={"frame_skip": 4, "screen_size": 84},
        use_vec_normalize=True,
        vec_normalize_kwargs={"training": False, "norm_reward": False, "gamma": 0.95},
    ...
    model = PPO(
        ...
        learning_rate=3e-4,
        gamma=0.95,  # Screen-width planning horizon (~53 steps, 3.5 sec game time)
        gae_lambda=0.95,
        ent_coef=0.01,
        clip_range=0.2,
        vf_coef=0.5,
        ...
        policy_kwargs=dict(
            ...
            features_extractor_kwargs=dict(
                features_dim=256,
                channels=[16, 32, 32],
                normalized_image=False,  # 2× base for 8-stage training
            ),
